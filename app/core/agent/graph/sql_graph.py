...
from app.core.agent.graph.react_bank_agent import execute_query_tool
...
num_turns = 1
sql_llm = ChatOpenAI(model="deepseek-ai/DeepSeek-V3.1-Terminus", api_key=API_KEY, base_url=BASE_URL, temperature=0.0)
...
def write_query(state: State):
    ...
    messages = [*prompt.messages, llm_res]
    return {
        **state,
        "raw_notes": sql_query,
